<div class="grid gap-4 md:grid-cols-2">
    ...
    @include('lotacoes.partials.select', ['name' => 'tipo', 'label' => 'Tipo', 'required' => true, 'options' => ['setor' => 'Setor', 'departamento' => 'Departamento', 'secretaria' => 'Secretaria', 'unidade' => 'Unidade', 'gabinete' => 'Gabinete'], 'value' => old('tipo', $lotacao->tipo ?? 'setor')])
