<div class="space-y-4">
    ...
    <div class="grid gap-4 md:grid-cols-2">
        ...
        @include('servidores.partials.field', ['name' => 'classificacao_tributaria', 'label' => 'Classificacao tributaria', 'required' => true, 'placeholder' => 'Ex.: 85', 'value' => old('classificacao_tributaria', $parametros['classificacao_tributaria'] ?? null)])
