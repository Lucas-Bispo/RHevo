...
- Regras locais de compatibilidade `S-1010` para bloquear combinacoes incoerentes entre natureza, tipo e incidencias de IRRF, INSS e FGTS.
...
- Catalogo local inicial de categorias de trabalhador suportadas para `S-2200`, reutilizado por validacao e formulario.
