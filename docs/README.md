# FolhaNova - Índice Central da Documentação
**Documento gerado automaticamente em:** 19 de abril de 2026
**Versão:** 1.0

## Visão Geral
Este índice organiza a documentação do projeto FolhaNova em trilhas temáticas, com foco em clareza, escalabilidade e manutenção contínua. A pasta `docs/obsidian/` foi preservada como acervo histórico e fonte de consulta, enquanto esta estrutura passa a ser a referência organizada.

## Índice
- [01-visao-projeto](./01-visao-projeto/README.md)
- [02-requisitos](./02-requisitos/README.md)
- [03-arquitetura](./03-arquitetura/README.md)
- [04-ciberseguranca](./04-ciberseguranca/README.md)
- [05-performance](./05-performance/README.md)
- [06-engenharia-software](./06-engenharia-software/README.md)
- [07-bug-prevention](./07-bug-prevention/README.md)
- [08-esocial](./08-esocial/README.md)
...
- [Diagnóstico inicial de performance](./05-performance/DIAGNOSTICO-INICIAL.md)
- [Análise da tela de login](./05-performance/ANALISE-TELA-LOGIN.md)
...
- Cada pasta temática deve manter seu próprio `README.md`.
- Documentos históricos em `docs/obsidian/` podem ser consultados, mas a organização oficial desta fase está nesta árvore.
- Mudanças estruturais devem atualizar este índice e o arquivo de organização do projeto.
